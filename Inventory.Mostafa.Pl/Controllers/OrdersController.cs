...
namespace Inventory.Mostafa.Pl.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [Cashed(60)]
        public async Task<ActionResult<ApiResponse<Pagination<IEnumerable<Orders>>>>> GetAllOrders([FromQuery] SpecParameter specParameter)
        {
            ...
            return Ok(new ApiResponse<Pagination<IEnumerable<OrdersDto>>>(true, 200, "Orders Retrived Successfully.",orders.Data));
        }

        [HttpGet("Type")]
        [Authorize(AuthenticationSchemes = "Bearer", Roles = "Admin,User")]
        [Cashed(60)]
        public async Task<ActionResult<ApiResponse<IEnumerable<Orders>>>> GetAllOrdersForSpecificType([FromQuery] OrderType orderType)
        {
            ...
            return Ok(new ApiResponse<IEnumerable<OrdersDto>>(true, 200, orders.Message, orders.Data));
        }
