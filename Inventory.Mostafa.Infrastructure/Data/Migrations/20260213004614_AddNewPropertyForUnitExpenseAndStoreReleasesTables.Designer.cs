...
namespace Inventory.Mostafa.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260213004614_AddNewPropertyForUnitExpenseAndStoreReleasesTables")]
    partial class AddNewPropertyForUnitExpenseAndStoreReleasesTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Mostafa.Domain.Entities.AssetsReturns.ReturnItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inventory.Mostafa.Domain.Entities.CustodayTables.CustodayTransfers", b =>
                {
                    ...
                    b.Property<string>("TransactionHijriDate")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
