...
namespace Inventory.Mostafa.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251027235347_UpdateCustodayTransferV3")]
    partial class UpdateCustodayTransferV3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Mostafa.Domain.Entities.CustodayTables.CustodayTransferItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CustodayTransfersId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustodayTransfersId");

                    b.HasIndex("ItemId");

                    b.ToTable("CustodayTransferItem");
                });
            ...
            modelBuilder.Entity("Inventory.Mostafa.Domain.Entities.CustodayTables.CustodayTransferItem", b =>
                {
                    b.HasOne("Inventory.Mostafa.Domain.Entities.CustodayTables.CustodayTransfers", "CustodayTransfers")
                        .WithMany("CustodayTransferItems")
                        .HasForeignKey("CustodayTransfersId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Inventory.Mostafa.Domain.Entities.CustodayTables.CustodayTransfers", b =>
                {
                    b.Navigation("CustodayTransferItems");
                });
